...
class Website
{
    ...
    /**
     * @var \RevisionTen\CMS\Entity\Domain[]
     * @ORM\OneToMany(targetEntity="RevisionTen\CMS\Entity\Domain", mappedBy="website", cascade={"persist"}, orphanRemoval=true)
     */
    private $domains;

    /**
     * @var \RevisionTen\CMS\Entity\Alias[]
     * @ORM\OneToMany(targetEntity="RevisionTen\CMS\Entity\Alias", mappedBy="website")
     */
    private $aliases;

    /**
     * @var \RevisionTen\CMS\Entity\UserRead[]
     * @ORM\ManyToMany(targetEntity="RevisionTen\CMS\Entity\UserRead", mappedBy="websites")
     */
    private $users;
     ...
     *
     * @ORM\ManyToMany(targetEntity="RevisionTen\CMS\Entity\PageStreamRead")
