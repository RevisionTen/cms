...
## [3.3.4] - 2024-02-26
### Changed
- Fix CKEditor dialog in bootstrap modal

## [3.3.3] - 2024-02-06
### Changed
- Fix conditional field validation in entity form

## [3.3.2] - 2023-10-26
### Changed
- Bugfixes
- Redirect back to list view after saving an entity
- Remove contrast button from toolbar

## [3.3.1] - 2023-09-07
### Changed
- Use select2 for  page menu item page selection
...
- **Update your custom `config/packages/security.yaml`**
